 ...
 */
		...
		function DrawHTMLBarcode_EAN8(data,
						    humanReadable,
						    units,
						    minBarWidth,
						    width,height,
						    ...
						    backColor)
		{
            ...
            function DrawBarcode_EAN8(data,
						    humanReadable,
						    units,
						    minBarWidth,
						    width,height,
						    ...
						    mode)
		{
			  ...
			  var encodedData=EncodeEAN8(data);	
	      ...
	      function EncodeEAN8(data)
        	{
            var fontOutput = ConnectCode_Encode_EAN8(data);
            var output = "";
            var pattern = "";
