 ...
 */
		...
		function DrawHTMLBarcode_Code128Auto(data,
						    humanReadable,
						    units,
						    minBarWidth,
						    width,height,
						    ...
						    backColor)
		{
            ...
            function DrawBarcode_Code128Auto(data,
						    humanReadable,
						    units,
						    minBarWidth,
						    width,height,
						    ...
						    mode)
		{
			  ...
			  var encodedData=EncodeCode128Auto(data);	
		...
		function EncodeCode128Auto(data)
        	{
		...
		function ConnectCode_Encode_Code128Auto(data)
		{
